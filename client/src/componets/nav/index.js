        ...
        {authenticated ? (
          <div className={NavStyles.rightSideNav}>
            ...
            <div>
              ...
              <div className={NavStyles.container2}>
                <Link className={`d-block ${NavStyles.linkBTN}`} to="/dashboard">
                  Dashboard
                </Link>
                <Link className={`d-block ${NavStyles.linkBTN}`} to="/account/profile">
                  Profile
                </Link>
                <span className={NavStyles.or}>or</span>
                <Link onClick={handleLogOut} className={NavStyles.linkBTN} to="/">
                  Logout
                </Link>
              </div>
            </div>
          ...
          <div className={NavStyles.rightSideNav}>
            ...
            <div>
              <span className="d-blcok">Account</span>
              <div className={NavStyles.container2}>
                <Link className={`d-block ${NavStyles.linkBTN}`} to="/account/login">
                  Login
                </Link>
                <span className={NavStyles.or}>or</span>
